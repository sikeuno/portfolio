      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center px-4 md:flex-row">
        <div className="flex flex-col justify-center md:w-1/2">
          ...
          <p className="text-gray-400 py-4 max-w-md">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias, ad rerum cum vel, quam sed iste eum
            accusamus omnis, harum atque dolor. Sed natus dolore facere rerum repudiandae animi illo?
          </p>
          <div>
            <Link
              to="portfolio"
